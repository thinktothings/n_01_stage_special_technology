package com.opensourcesteam.java.enhance.n_01_socket_报文定制.v_01_socket_单个字段的报文定制.test;
...
import com.opensourcesteam.java.enhance.n_01_socket_报文定制.v_01_socket_单个字段的报文定制.util.DataPacketUtil;
...
public class DataPacketUtilTest {
    ...
    public void analyzingData() throws Exception {
        DataPacketBean dataPacketBean = new DataPacketBean("002","00001","你好","111");
